...
\pic[shift={(0,0,0)}] at (0,0,0) {RightBandedBox={name=cr1,%
        xlabel={{"3","32","32"}},caption=I,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=40,width={1,2,2},depth=40}};
%pool1
...
\pic[shift={(0,0,0)}] at (up4-east) {RightBandedBox={name=ucr4,%
        xlabel={{"256","dummy"}},caption=I/8,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(0,0,0)}] at (up3-east) {RightBandedBox={name=ucr3,%
        xlabel={{"128","dummy"}},caption=I/4,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(0,0,0)}] at (up2-east) {RightBandedBox={name=ucr2,%
        xlabel={{"64","dummy"}},caption=I/2,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\pic[shift={(0,0,0)}] at (up1-east) {RightBandedBox={name=ucr1,%
        xlabel={{"32","dummy"}},caption=I,fill=\ConvColor,bandfill=\ConvReluColor,%
...
%% Classifier 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pic[shift={(2,5,0)}] at (ucr1a-east) {Box={name=soma,caption=soma,%
        zlabel=I,fill=\SoftmaxColor,height=40,width=1,depth=40}};
\pic[shift={(2,-5,0)}] at (ucr1a-east) {Box={name=vessel,caption=vessel,%
        zlabel=I,fill=\SoftmaxColor,height=40,width=1,depth=40}};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Draw connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\draw [connection]  (ucr1a-east) -- node {\midarrow} (soma-west);
\draw [connection]  (ucr1a-east) -- node {\midarrow} (vessel-west);
